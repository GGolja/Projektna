...
namespace Projektna.Controllers_Api
{
    [Route("api/v1/branch")]
    [ApiController]
    public class BranchesApiController : ControllerBase
    {
        ...
        public BranchesApiController(StoreContext context)
        {
            _context = context;
        }
